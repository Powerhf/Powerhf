# Generated by Django 5.0 on 2024-03-07 08:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('EB_Cumulative_KWH_Image', models.ImageField(upload_to='EB Cumulative KWH (As Per EB Meter)/%y', verbose_name='EB Cumulative KWH (As Per EB Meter) Image')),
                ('EB_Running_Hours_Cumulative_Image', models.ImageField(upload_to='EB Cumulative KWH (As Per EB Meter)/%y', verbose_name='EB Cumulative KWH (As Per EB Meter) Image')),
                ('DG_Running_Hours_Reading_Image', models.ImageField(upload_to='DG Running Hours Reading (As Per HMR Meter)/%y', verbose_name='DG Running Hours Reading (As Per HMR Meter) Image')),
                ('DG_Running_Hours_as_per_piu_Reading_Image', models.ImageField(upload_to='DG Running Hours Reading (As Per PIU/12PMS/AMF)/%y', verbose_name='DG Running Hours Reading (As Per PIU/12PMS/AMF) Image')),
                ('Diesel_Bill_Number_Image', models.ImageField(upload_to='Diesel Bill Number/%y', verbose_name='Diesel Bill Number Image')),
